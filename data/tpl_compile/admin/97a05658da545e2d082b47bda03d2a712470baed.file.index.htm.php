<?php /* Smarty version Smarty-3.0.6, created on 2014-08-06 19:06:44
         compiled from "D:/project/php//CoreCMSV1.0_en/core/common/skin/admin\info/index/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:2069853e20c4409baa4-61254683%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97a05658da545e2d082b47bda03d2a712470baed' => 
    array (
      0 => 'D:/project/php//CoreCMSV1.0_en/core/common/skin/admin\\info/index/index.htm',
      1 => 1358997717,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2069853e20c4409baa4-61254683',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_int2string')) include 'D:\project\php\CoreCMSV1.0_en\core\smarty\plugins\function.int2string.php';
?><!DOCTYPE HTML>
<html>
<head>
...
<?php }?></a></td>
 ...
 (<?php echo $_smarty_tpl->tpl_vars['item']->value['userDisplayName'];?>
					...
					<?php }} ?>
					<td>
						<?php if (($_smarty_tpl->getVariable('class_id')->value==''&&$_smarty_tpl->tpl_vars['item']->value['hideColumn']['info_delete'])||($_smarty_tpl->getVariable('class_id')->value!=''&&$_smarty_tpl->getVariable('hideColumn')->value['info_delete'])){?><a href="<?php echo $_smarty_tpl->getVariable('refreshUrl')->value;?>
act=delete&class_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['classId'];?>
&id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" class="lnkDelete" onclick="return chkDelete();"></a><?php }?>
					</td>
				</tr>
			<?php }} ?>
			</form>
