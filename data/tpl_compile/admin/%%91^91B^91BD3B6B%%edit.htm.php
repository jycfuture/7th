<?php /* Smarty version 2.6.26, created on 2012-04-04 22:08:18
         compiled from system/role/edit.htm */ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="wrap inner clearfix">
	<div class="container">
		<div class="tips">
			...
			<a href="?con=admin&ctl=system/role&act=delete&id=<?php echo $this->_tpl_vars['data']['id']; ?>
" class="lnkDelete" onclick="return chkDelete();">Delete</a>
		</div>
		<form action="?con=admin&ctl=system/role&act=edit&id=<?php echo $this->_tpl_vars['data']['id']; ?>
" method="post" onsubmit="return check(this);">
			<table width="98%" align="center" height="100%" border="0" cellspacing="0" cellpadding="0" class="editTable">
				<tr class="editHdTr">
					<td colspan="2">Edit role</td>
				</tr>
				<tr class="editTr">
...
?><p>Description: <?php echo $this->_tpl_vars['item']['description']; ?>
				...
				<tr class="editTr">
					...
					<td class="editRtTd">
						<input type="checkbox" id="chkSystem" name="data[isSystem]" value="1"<?php if ($this->_tpl_vars['data']['isSystem']): ?> checked<?php endif; ?> /><label for="chkSystem">System role</label> 
						<input type="checkbox" id="chkSuper" name="data[isSuper]" value="1"<?php if ($this->_tpl_vars['data']['isSuper']): ?> checked<?php endif; ?> /><label for="chkSuper">Super role</label>
					</td>
				</tr>
				<?php endif; ?>
				<tr class="editFtTr">
