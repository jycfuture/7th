<?php /* Smarty version 2.6.26, created on 2012-11-19 19:56:10
         compiled from adv/subscribe/add.htm */ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="wrap inner clearfix">
	<div class="container">
		...
		<form id="editForm" action="?con=admin&ctl=adv/subscribe&act=add" method="post">
			<table width="98%" align="center" height="100%" border="0" cellspacing="0" cellpadding="0" class="editTable">
				<tr class="editHdTr">
					<td colspan="2">Create e-mail</td>
				</tr>
				<tr class="editTr">
