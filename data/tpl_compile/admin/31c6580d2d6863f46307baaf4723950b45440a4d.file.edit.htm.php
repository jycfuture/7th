<?php /* Smarty version Smarty-3.0.6, created on 2018-04-23 18:02:31
         compiled from "D:/www/ark/core/common/skin/admin\info/index/edit.htm" */ ?>
<?php /*%%SmartyHeaderCode:286425ade1fb749d605-96550394%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31c6580d2d6863f46307baaf4723950b45440a4d' => 
    array (
      0 => 'D:/www/ark/core/common/skin/admin\\info/index/edit.htm',
      1 => 1524506549,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '286425ade1fb749d605-96550394',
  'function' => 
  array (
  ),
				...
				<tr class="editTr">
					...
					<td class="editRtTd">
						<select name="data[areaId]">
							<option <?php if ($_smarty_tpl->getVariable('data')->value['areaId']==1){?>selected='selected'<?php }?> value="1">悉尼</option>
							<option <?php if ($_smarty_tpl->getVariable('data')->value['areaId']==2){?>selected='selected'<?php }?> value="2">墨尔本</option>
							<option <?php if ($_smarty_tpl->getVariable('data')->value['areaId']==3){?>selected='selected'<?php }?> value="3">布里斯班</option>
						</select>
					</td>
				</tr>
				<?php }?>
...
<?php }?></td>
						<td class="editRtTd"><input  class="<?php if ($_smarty_tpl->getVariable('class_id')->value=='103'){?>search-address<?php }?>  text"name="data[author]" value="<?php echo $_smarty_tpl->getVariable('data')->value['author'];?>
" type="text" size="60" class="" /></td>
					</tr>
				<?php }?>
